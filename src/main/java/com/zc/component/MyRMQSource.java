 ...
 * WITHBasicProperties WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
 ...
 * 3) No strong delivery guarantees (withBasicProperties checkpointing) with RabbitMQ auto-commit mode.
 *
 ...
 *
 * @param <BasicProperties> The type of the data read from RabbitMQ.
 */
public class MyRMQSource<BasicProperties> extends MultipleIdsMessageAcknowledgingSourceBase<BasicProperties, String, Long>
		implements ResultTypeQueryable<BasicProperties> {

	private static final long serialVersionUID = 1L;

	private static final Logger LOG = LoggerFactory.getLogger(org.apache.flink.streaming.connectors.rabbitmq.RMQSource.class);

	private final RMQConnectionConfig rmqConnectionConfig;
	protected final String queueName;
	private final boolean usesCorrelationId;
	protected DeserializationSchema<BasicProperties> schema;
	 ...
	 * {@link org.apache.flink.streaming.connectors.rabbitmq.RMQSource#RMQSource(RMQConnectionConfig, String, boolean, DeserializationSchema)}.
	 ...
	 *               				into Java objects.
	 */
	public MyRMQSource(RMQConnectionConfig rmqConnectionConfig, String queueName,
					 DeserializationSchema<BasicProperties> deserializationSchema) {
	 ...
	 *                              into Java objects.
	 */
	public MyRMQSource(RMQConnectionConfig rmqConnectionConfig,
					 String queueName, boolean usesCorrelationId, DeserializationSchema<BasicProperties> deserializationSchema) {
		super(String.class);
	...
	@Override
	public void run(SourceContext<BasicProperties> ctx) throws Exception {
		while (running) {
			...
			synchronized (ctx.getCheckpointLock()) {
				...
				MsgHeader header = new MsgHeader(properties.getHeaders().get("msgId").toString(),properties.getTimestamp() == null ? new Date() : properties.getTimestamp());
				String json = oMapper.writeValueAsString(header);
				BasicProperties result = schema.deserialize(json.getBytes());
	...
	@Override
	public TypeInformation<BasicProperties> getProducedType() {
